...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final NowPlayingMoviesController nowPlayingController = Get.find<NowPlayingMoviesController>();
    final TopRatedMoviesController topRatedController = Get.find<TopRatedMoviesController>();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                FutureBuilder<HomeScreenResponse>(
                  future: controller.fetchHomeScreenResponse(),
